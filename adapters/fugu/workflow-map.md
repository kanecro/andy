...
| User intent / short command | andy workflow |
|---|---|
| `brainstorm ...`, idea / requirement discussion | `core/workflows/brainstorm.md` |
| `spec ...`, create spec / design | `core/workflows/spec.md` |
| `implement ...`, implement approved work | `core/workflows/implement.md` |
